...
* $Id: std::vector.h
*
* This file implement a mathlib of std::vector
* 3D std::vector is a useful data type in computer graphics
*
*/

#ifndef UTILVECTOR_H_INCLUDED
#define UTILVECTOR_H_INCLUDED
...
//operators
	...
	/*friend bool PointinTriangle(const Self &A, const Self &B, const Self &C, const Self &P)
	{
		Self v0 = C - A ;
		Self v1 = B - A ;
		Self v2 = P - A ;
...
//basic recursive functions
    ...
    {
        std::vector<typename F::result_type> out(max(m.size(), other.m.size()));
